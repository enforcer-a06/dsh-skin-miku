	...
	factory: (require) => {
		...
		const SKIN = {
			...
			tokens: {
				...
				"--dsw-alias-label-secondary": "#6dd6c6",
				"--dsw-alias-label-tertiary": "#44a99a",
				"--dsw-alias-label-caption": "#529a90",
				"--dsw-alias-label-dimmed": "#529a90",
				"--dsw-alias-label-primary-bluish": "#56d0bd",
				"--dsw-alias-label-primary-dimmed": "#6dd6c6",
				...
				"--dsw-specific-bubble": "#17302b",
				"--dsw-specific-bubble-highlight": "#1d3a33",
